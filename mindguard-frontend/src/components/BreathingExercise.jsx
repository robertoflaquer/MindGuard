      ...
      <div className="w-full max-w-sm rounded-3xl p-6 relative animate-fade-up"
        ...
        {!started && !done && (
          <div className="text-center space-y-4">
            ...
            <button
              onClick={() => { setStarted(true); setCountdown(PHASES[0].duration) }}
        ...
        {started && !done && (
          <div className="text-center space-y-6">
            ...
            <div className="relative flex items-center justify-center" style={{ height: 200 }}>
              ...
              <div
                ...
                style={{
                  ...
                  transition: `transform ${phase.duration}s ease-in-out, background ${0.6}s`,
              ...
              <div
                ...
                style={{
                  ...
                  transform: `scale(${phase.scale})`,
                  transition: `transform ${phase.duration}s ease-in-out, background ${0.6}s, border-color ${0.6}s`,
                }}
              >
                <span className="text-4xl font-extrabold tabular-nums" style={{ color: phase.color }}>
                  {countdown}
                </span>
              </div>
            </div>
            ...
            <div>
              <p className="text-lg font-bold" style={{ color: phase.color, fontFamily: 'Nunito, system-ui, sans-serif' }}>
                {phase.label}
              </p>
              <p className="text-xs mt-1" style={{ color: 'var(--text-muted)' }}>
                Ciclo {Math.min(cyclesDone + 1, TOTAL_CYCLES)} de {TOTAL_CYCLES}
              </p>
            </div>
